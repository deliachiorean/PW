...
if(isset($_POST["email"]))
{
 ...
 (first_name, last_name, gender, email, password, address, mobile_no) VALUES ('$first_name','$last_name','$gender','$password_hash','$address','$mobile_no')";
...
<html>
 ...
 <br />
  <div class="container box">
   ...
   <?php echo $message; ?>
   <form method="post" id="register_form" enctype="multipart/form-data" autocomplete="off">
