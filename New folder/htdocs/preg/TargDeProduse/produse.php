    ...
    function list() {
        $.ajax({
            ...
            .done(function (data) {
                ...
                var content = "<tr><td>Nume</td><td>Descrie<td>Producator</td><td>Pret</td><td>Cantitate</td><td>Poza</td></tr>";
                for (var i = 0; i < products.length; i++) {
                   ...
                   content += "<td id='poza"+ + products[i].id + "'>"+"<img src='"+ products[i].poza +">"+"</td>";
                    content += "</tr>";
                }
